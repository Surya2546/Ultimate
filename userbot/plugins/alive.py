...
if HELL_PIC is None:
    HELL_IMG = "https://telegra.ph/file/96cf032502cf3362690de.jpg"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/be391ac498e146afc93f6.jpg"
else:
    CAT_IMG = CAT_IMGE
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        ...
        return
    req = requests.get("https://telegra.ph/file/96cf032502cf3362690de.jpg")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
            ...
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/Ult_imate)\n"
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/Ult_imate)\n"
            "𝘓𝘐𝘚𝘌𝘕𝘊𝘌                  : [AGPL-3.0  ʟɪᴄᴇɴꜱᴇ]()\n"
            "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ Ultimate ](https://t.me/Ult_imate)\n"
            "[ ┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/Ult_imate)",
            link_preview=False,
        )
        await salive.delete()
...
pm_caption = "__**🔥🔥Ultimate ɨs օռʟɨռɛ🔥🔥**__\n\n"
...
pm_caption += f"😈Ultimate😈       : __**{hellversion}**__\n"

pm_caption += f"⚜️Sudo⚜️            : `{sudou}`\n"

pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/Ult_imate)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/youngchris112)\n\n"

pm_caption += "    [✨REPO✨](https://github.com/chrisdroid1/Ultimate) 🔹 [📜License📜](https://github.com/KeinShin/Black-Lightning/blob/master/LICENSE)"
...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "@Ult_imate"
